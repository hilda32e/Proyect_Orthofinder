...
#Ciclo que extrae los datos del archivo $1 la columna 2 (-f2) y ejecuta el wget -P que Permite la descarga de los links de nuestra lista  $1 y con -P permitió que en la carpeta creada se almacenen los archivos FASTA descargados de los links.
for x in $(cut -f2 $1)
do
